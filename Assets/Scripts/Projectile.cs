...
public class Projectile : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        // we switched Health to IDamageable to support more systems
        // from the Unity/Component side, Interfaces are *almost* interchangeable with classes
        if (other.TryGetComponent(out IDamageable damageable)) damageable.Damage(damageInfo);
